            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  disabled={isAuthLoading || googleButtonState !== 'idle'}
                  className={`google-login-btn flex items-center justify-center gap-2 py-3 rounded-xl text-white transition-all font-medium relative overflow-hidden ${
                    googleButtonState === 'idle'
                      ? 'bg-[#1C2842] hover:bg-[#243049] border border-[#243049] hover:shadow-lg hover:shadow-blue-500/20'
                      : googleButtonState === 'loading'
                      ? 'bg-[#0BA5EC] border border-[#0BA5EC] animate-pulse'
                ...
                >
                  ...
                  <div className={`relative transition-all ${
                    googleButtonState === 'loading' ? 'animate-spin' : ''
                  }`}>
                  ...
                  <span className={`text-sm transition-all ${
                    googleButtonState === 'loading' ? 'opacity-70' : ''
                  }`}>
                    {googleButtonState === 'loading' ? 'Signing in...' : googleButtonState === 'success' ? 'Success!' : 'Google'}
                  </span>
                </button>
                <button
                  type="button"
