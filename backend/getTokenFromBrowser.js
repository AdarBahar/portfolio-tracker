...
console.log('5. Copy the token (without quotes) and paste it below\n');

console.log('─'.repeat(60));
console.log('\n💡 TIP: You can also create a bookmarklet for quick access:\n');
console.log('Bookmark this JavaScript code:');
